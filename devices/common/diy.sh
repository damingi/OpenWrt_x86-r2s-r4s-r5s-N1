...
luci-app-wizard luci-app-argon-config luci-app-bypass luci-app-openclash luci-app-serverchan luci-app-turboacc luci-app-unblockmusic luci-app-store luci-app-webadmin \
luci-app-wifischedule luci-app-zerotier luci-app-cpufreq luci-base luci-compat luci-lib-ipkg luci-lib-fs \
...
sed -i "s/192.168.1/192.168.3.1/" package/feeds/kiddin9/base-files/files/bin/config_generate
